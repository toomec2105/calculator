...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"public/index.js":[function(require,module,exports) {
//HTML elements
...
var historyDisplay = document.getElementById("history"); //other variables
...
digitContainer.addEventListener("click", function fn(e) {
  ...
  if (operator == null) {
    ...
    console.log("i am adding to num1"); //console.log(typeof x);  Number
  } else {
    num2 += e.target.id;
...
function calculate() {
  ...
  var record = createRecord(num1, num2, symbol, result);
  records.push(record);
  var recordString = createRecordString();
...
function createRecordString() {
  ...
  for (var i = 0; i < records.length; i++) {
    recordsString = records[i].num1 + " " + records[i].symbol + " " + records[i].num2 + " = " + Number(records[i].result).toFixed(2);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","public/index.js"], null)
//# sourceMappingURL=/public.8649ca97.js.map